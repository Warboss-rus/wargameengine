...
LDLIBSOPTIONS=../../MathLib/MathLib/dist/Debug/GNU-Linux-x86/libmathlib.a ../../LUA/LUA/liblua.a
...
${OBJECTDIR}/LogWriter.o: LogWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LogWriter.o LogWriter.cpp

${OBJECTDIR}/Module.o: Module.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Module.o Module.cpp
...
${OBJECTDIR}/ThreadPool.o: ThreadPool.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ThreadPool.o ThreadPool.cpp

${OBJECTDIR}/TranslationManager.o: TranslationManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TranslationManager.o TranslationManager.cpp

${OBJECTDIR}/UI/UIButton.o: UI/UIButton.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UIButton.o UI/UIButton.cpp

${OBJECTDIR}/UI/UICheckBox.o: UI/UICheckBox.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UICheckBox.o UI/UICheckBox.cpp

${OBJECTDIR}/UI/UIComboBox.o: UI/UIComboBox.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UIComboBox.o UI/UIComboBox.cpp

${OBJECTDIR}/UI/UIEdit.o: UI/UIEdit.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UIEdit.o UI/UIEdit.cpp

${OBJECTDIR}/UI/UIElement.o: UI/UIElement.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UIElement.o UI/UIElement.cpp

${OBJECTDIR}/UI/UIList.o: UI/UIList.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UIList.o UI/UIList.cpp

${OBJECTDIR}/UI/UIPanel.o: UI/UIPanel.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UIPanel.o UI/UIPanel.cpp

${OBJECTDIR}/UI/UIRadioGroup.o: UI/UIRadioGroup.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UIRadioGroup.o UI/UIRadioGroup.cpp

${OBJECTDIR}/UI/UIScrollBar.o: UI/UIScrollBar.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UIScrollBar.o UI/UIScrollBar.cpp

${OBJECTDIR}/UI/UIStaticText.o: UI/UIStaticText.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UIStaticText.o UI/UIStaticText.cpp

${OBJECTDIR}/UI/UIText.o: UI/UIText.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UIText.o UI/UIText.cpp

${OBJECTDIR}/UI/UITheme.o: UI/UITheme.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/UITheme.o UI/UITheme.cpp
...
${OBJECTDIR}/controller/CommandChangeGlobalProperty.o: controller/CommandChangeGlobalProperty.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controller/CommandChangeGlobalProperty.o controller/CommandChangeGlobalProperty.cpp

${OBJECTDIR}/controller/CommandChangeProperty.o: controller/CommandChangeProperty.cpp 
	${MKDIR} -p ${OBJECTDIR}/controller
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controller/CommandChangeProperty.o controller/CommandChangeProperty.cpp

${OBJECTDIR}/controller/CommandCompound.o: controller/CommandCompound.cpp 
	${MKDIR} -p ${OBJECTDIR}/controller
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controller/CommandCompound.o controller/CommandCompound.cpp

${OBJECTDIR}/controller/CommandCreateObject.o: controller/CommandCreateObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/controller
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controller/CommandCreateObject.o controller/CommandCreateObject.cpp

${OBJECTDIR}/controller/CommandDeleteObject.o: controller/CommandDeleteObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/controller
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controller/CommandDeleteObject.o controller/CommandDeleteObject.cpp

${OBJECTDIR}/controller/CommandHandler.o: controller/CommandHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/controller
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controller/CommandHandler.o controller/CommandHandler.cpp

${OBJECTDIR}/controller/CommandMoveObject.o: controller/CommandMoveObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/controller
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controller/CommandMoveObject.o controller/CommandMoveObject.cpp

${OBJECTDIR}/controller/CommandRotateObject.o: controller/CommandRotateObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/controller
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controller/CommandRotateObject.o controller/CommandRotateObject.cpp
...
${OBJECTDIR}/view/GameView.o: view/GameView.cpp 
	${MKDIR} -p ${OBJECTDIR}/view
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/view/GameView.o view/GameView.cpp

${OBJECTDIR}/view/Input.o: view/Input.cpp 
	${MKDIR} -p ${OBJECTDIR}/view
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/view/Input.o view/Input.cpp

${OBJECTDIR}/view/MaterialManager.o: view/MaterialManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/view
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/view/MaterialManager.o view/MaterialManager.cpp

${OBJECTDIR}/view/ModelManager.o: view/ModelManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/view
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/view/ModelManager.o view/ModelManager.cpp
...
${OBJECTDIR}/view/ShaderManager.o: view/ShaderManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/view
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/view/ShaderManager.o view/ShaderManager.cpp
...
${OBJECTDIR}/view/TextWriter.o: view/TextWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}/view
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/view/TextWriter.o view/TextWriter.cpp

${OBJECTDIR}/view/TextureManager.o: view/TextureManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/view
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/view/TextureManager.o view/TextureManager.cpp

${OBJECTDIR}/view/WBMModelFactory.o: view/WBMModelFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/view
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -w -I../../LUA/LUA -I../../MathLib/MathLib -I/usr/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/view/WBMModelFactory.o view/WBMModelFactory.cpp
