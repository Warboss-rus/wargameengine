...
public:
	...
	int GetStringWidth(const std::wstring& text, const std::string& font, unsigned fontSize) const override;
	int GetStringHeight(const std::wstring& text, const std::string& font, unsigned fontSize) const override;
private:
