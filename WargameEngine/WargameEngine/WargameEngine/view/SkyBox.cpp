...
void CSkyBox::Draw(double x, double y, double z, double scale)
{
	...
	if (!m_list)
	{
		m_list = m_renderer.CreateDrawingList([&] {
			...
			// Top side
			m_renderer.SetTexture(m_imageFolder + "/top.bmp", false, TextureFlags::TEXTURE_NO_WRAP);
			...
			// Bottom side
			m_renderer.SetTexture(m_imageFolder + "/bottom.bmp", false, TextureFlags::TEXTURE_NO_WRAP);
			...
			// Front side
			m_renderer.SetTexture(m_imageFolder + "/front.bmp", false, TextureFlags::TEXTURE_NO_WRAP);
			...
			// Back side
			m_renderer.SetTexture(m_imageFolder + "/back.bmp", false, TextureFlags::TEXTURE_NO_WRAP);
			...
			// Left side
			m_renderer.SetTexture(m_imageFolder + "/left.bmp", false, TextureFlags::TEXTURE_NO_WRAP);
			...
			// Right side
			m_renderer.SetTexture(m_imageFolder + "/right.bmp", false, TextureFlags::TEXTURE_NO_WRAP);
