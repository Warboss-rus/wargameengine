...
constexpr char NEW_BUTTON[] = "NewButton";
...
constexpr char NEW_STATIC_TEXT[] = "NewStaticText";
...
constexpr char NEW_PANEL[] = "NewPanel";
...
constexpr char NEW_CHECKBOX[] = "NewCheckbox";
...
constexpr char NEW_COMBOBOX[] = "NewCombobox";
...
constexpr char NEW_EDIT[] = "NewEdit";
...
constexpr char NEW_LIST[] =  "NewList";
...
constexpr char NEW_RADIOGROUP[] = "NewRadioGroup";
...
constexpr char GET_CHILD[] = "GetChild";
...
constexpr char SET_VISIBLE[] = "SetVisible";
...
constexpr char GET_VISIBLE[] = "GetVisible";
...
//If called without instance, root element will be used as the instance
constexpr char SET_TEXT[] = "SetText";
...
constexpr char ADD_ITEM[] = "AddItem";
...
//If called without instance, root element will be used as the instance.
constexpr char DELETE_ITEM[] = "DeleteItem";
...
constexpr char GET_SELECTED_INDEX[] = "GetSelectedIndex";
...
//If called without instance, root element will be used as the instance.
constexpr char SET_SELECTED_INDEX[] = "SetSelectedIndex";
...
constexpr char GET_ITEMS_COUNT[] = "GetItemsCount";
...
constexpr char CLEAR_CHILDREN[] = "ClearChildren";
...
constexpr char DELETE_CHILD[] = "DeleteChild";
...
constexpr char SET_ON_CHANGE_CALLBACK[] = "SetOnChangeCallback";
...
constexpr char SET_ON_CLICK_CALLBACK[] = "SetOnClickCallback";
...
constexpr char SET_BACKGROUND_IMAGE[] = "SetBackgroundImage";
...
constexpr char SET_SCALE[] = "SetScale";
...
constexpr char PROPERTY_VISIBLE[] = "visible";
...
constexpr char PROPERTY_TEXT[] = "text";
...
constexpr char PROPERTY_WIDTH[] = "width";

//Returns the height of an element.
constexpr char PROPERTY_HEIGHT[] = "height";

/*FUNCTIONS*/
//void MessageBox(string text, string caption)
//Displays message box with specified text and caption
constexpr char MESSAGE_BOX[] = "MessageBox";
