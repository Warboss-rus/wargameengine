...
function Start()
	...
	local path = {
		...
		{ {0, -24.5, 0.5}, 	{0, 0, 90}, 	0 },--0
		{ {0, -22.5, 0.8}, 	{0, 45, 90}, 	1},--1
		{ {0, -10.5, 15}, 	{0, 45, 90}, 	14},--15
		{ {0, -9, 15.5}, 	{0, 0, 90}, 	1},--16
		{ {0, -7.5, 15}, 	{0, -65, 90}, 	1},--17
		{ {0, -3, 2.3}, 	{0, -65, 90}, 	3.5},--20.5
		{ {0, -1.2, 2}, 	{0, 0, 90}, 	0.75},--21.25
		--second hill
		{ {0, 0.5, 2.3}, 	{0, 60, 90}, 	0.75},--22
		{ {0, 3.3, 9.5}, 	{0, 60, 90}, 	3},--25
		{ {0, 5.1, 10.5}, 	{0, 0, 90}, 	0.75},--25.75
		{ {0, 6.5, 9.5}, 	{0, -60, 90}, 	0.75},--26.5
		{ {0, 8.5, 4}, 		{0, -60, 90}, 	1.5},--28
		{ {0, 10, 3}, 		{0, 0, 90}, 	0.5},--28.5
		--third hill
		{ {0, 12, 3.5}, 	{0, 55, 90}, 	0.5},--32.5
		{ {0, 14.5, 8.5}, 	{0, 55, 90}, 	1.5},--35
		{ {0, 16, 9}, 		{0, 0, 90}, 	0.6},--35.75
		{ {0, 17.5, 8.5}, 	{0, -65, 90}, 	0.6},--36.5
		{ {0, 18.5, 4.5}, 	{0, -65, 90}, 	1},--38
		...
		{ {4, 6, 3.7}, 		{0, -90, -90}, 	1},--48.5
		{ {4, 8, 6}, 		{0, -180, -90}, 1},--49.5
		{ {4.5, 10, 3.7}, 	{0, -270, -90}, 1},--50.5
		{ {5.25, 8, 1.3}, 	{0, -360, -90}, 1},--51.5
		{ {5.25, 8, 1.3}, 	{0, 0, -90}, 	0},--51.5
		--second loop
		{ {5.25, 2, 1.3}, 	{0, 0, -90}, 	1},--52.5
		{ {4.75, 0, 3.7}, 	{0, -90, -90}, 	1},--53.5
		{ {4.75, 2, 6}, 	{0, -180, -90}, 1},--54.5
		{ {5.25, 4, 3.7}, 	{0, -270, -90}, 1},--55.5
		{ {6, 2, 1.3}, 		{0, -360, -90}, 1},--56.5
